...
from eoSip_converter.esaProducts import product_EOSIP, eosip_product_helper
...
from eoSip_converter.esaProducts.definitions_EoSip import rep_footprint, sipBuilder
