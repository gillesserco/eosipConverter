# -*- coding: cp1252 -*-
#
# TODO: 2016/08/01 remove; should not be needed because import are cleaned
#
...
#try:
#    from esaProducts import netCDF_reaper_product
#except:
#    print "ERROR importing netcdf4 library"
