...
REF_NAME='SP6_OPER_NAO_P_S_3__20001122T112233_20001122T112233_oooooo_tttt_0001.SIP.ZIP'
...
class ingester_spot_scene(ingester.Ingester):
        ...
        def beforeReportsDone(self, processInfo):
                ...
                processInfo.destProduct.browseBlockDisabled = not processInfo.srcProduct.has_boundingBoxAndBrowseBlock
        ...
        def afterProductDone(self, processInfo):
                ...
                if not self.test_dont_write and self.create_kmz:
                    ...
                    processLevel = processInfo.srcProduct.metadata.getMetadataValue(metadata.METADATA_PROCESSING_LEVEL)
                ...
                self.keepInfo(processInfo.srcProduct.metadata.getMetadataValue(metadata.METADATA_PROFILE), processInfo.srcProduct.metadata.getMetadataValue(metadata.METADATA_TYPECODE))
