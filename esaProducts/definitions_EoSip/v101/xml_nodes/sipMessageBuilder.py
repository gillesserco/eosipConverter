...
piecesDir = os.path.dirname(os.path.abspath(inspect.getfile(inspect.currentframe())))
if piecesDir not in sys.path:
     sys.path.insert(0, piecesDir)

#import esaProducts.definitions_EoSip.sipBuilder as sipBuilder
#from esaProducts.definitions_EoSip.sipBuilder import SipBuilder
    ...
    def addToSipMessage(self, mess, segment, met=None, optional=False):
        if mess is not None:
            ...
            if pos<0:
                ...
                #
                if self.debug != 0: print "@@@@@@@@@@@\n@@@@@@@@@@@@@@\n@@@@@@@@@@@@@ field '%s' result 0: found=%s" % (segment, found)
                if found:
                    return "%s%s" % (mess, tmp)
                elif optional==False:
                    return "%s%s" % (mess, tmp)
                ...
                #
                if self.debug != 0: print "@@@@@@@@@@@\n@@@@@@@@@@@@@@\n@@@@@@@@@@@@@ field '%s' result 1: found=%s" % (segment, found)
                if found:
                    return "%s%s" % (mess, tmp)
                elif optional==False:
                    return "%s%s" % (mess, tmp)
