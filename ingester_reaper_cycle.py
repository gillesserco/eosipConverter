...
from eoSip_converter.esaProducts import product_directory, product_netCDF_reaper, product_EOSIP, reaper_cycle
...
import eoSip_converter.indexCreator as indexCreator, eoSip_converter.shopcartCreator as shopcartCreator
from eoSip_converter.satellites import ers1cycles, ers2cycles
...
class ingester_reaper_cycle(ingester.Ingester):
        ...
        def output_eoSip(self, processInfo, basePath, pathRules, overwrite=None):
                ...
                for item in processInfo.srcProduct.contentList:
                        ...
                        piece = product_EOSIP.EoPiece(item)
