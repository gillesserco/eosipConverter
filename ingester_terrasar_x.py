...
VERSION="Terrasar-x converter V:1.0.0"
...
class ingester_terrasar_x(ingester.Ingester):
        ...
        def beforeReportsDone(self, processInfo):
            ...
            print("######@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ beforeReportsDone 0; bmet dump:%s" % bmet.toString())
            if processInfo.srcProduct.useBbox==False:
                ...
                #
                if 1==2: # BUG: introduce mapping that is used by all succesive conversion
                    processInfo.destProduct.metadata.xmlNodeUsedMapping['/sar_EarthObservation/om_result/eop_EarthObservationResult/BROWSES'] = 'UNUSED'
                    if 1==2: # not anymore because we remove the whole BROWSES block
                        bmet.xmlNodeUsedMapping['/eop:browse/eop:type'] = 'UNUSED'
                        bmet.xmlNodeUsedMapping['/eop:browse/eop:referenceSystemIdentifier'] = 'UNUSED'
                ...
                if 1==1:
                    ...
                    origHref = bmet.getMetadataValue(browse_metadata.BROWSE_METADATA_FILENAME)
        ...
        def afterReportsDone(self, processInfo):
            ...
            if processInfo.srcProduct.useBbox:
                ...
                processInfo.srcProduct.metadata.setMetadataPair(metadata.METADATA_KMZ_USE_BOOUNDINGBOX, False)
        ...
        def extractMetadata(self, met, processInfo):
            ...
            # refine
            if processInfo.srcProduct.isWorldDem:
                processInfo.srcProduct.refineMetadataWorldDem()
            else:
...
if __name__ == '__main__':
    try:
        if len(sys.argv) > 1:
            ...
            print >>out, "Terrasar-x conversion report"
            print >>out, report
