...
from eoSip_converter.esaProducts import product_EOSIP, product_aeolus, product_aeolus_aux
from eoSip_converter.esaProducts import metadata, browse_metadata
from eoSip_converter.esaProducts import definitions_EoSip, namingConvention ,formatUtils
from eoSip_converter.esaProducts.definitions_EoSip import rep_footprint, sipBuilder, rep_rectifiedBrowse
from eoSip_converter.esaProducts.namingConvention import NamingConvention
from eoSip_converter.esaProducts.namingConvention_aeolus import NamingConvention_Aeolus

import ingester_aeolus


# minimum config version that can be use
MIN_CONFIG_VERSION=1.0

class ingester_aeolus_aux(ingester_aeolus.ingester_aeolus):
        ...
        def createSourceProduct(self, processInfo):
            ...
            aeolusP = product_aeolus_aux.Product_Aeolus_Aux(processInfo.srcPath, None)
